...
<?php
$meta_data = logistics_post_meta_data();
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="zo-portfolio-detail">
                <div class="zo-portfolio-title">
                    <h2><label><?php esc_html_e('Project:', 'am-logistics'); ?></label><?php the_title(); ?></h2>
                </div>
                <div class="portfolio-client">
                    <p><label><?php esc_html_e('Client:', 'am-logistics'); ?></label><?php echo esc_attr($meta_data->_zo_portfolio_client) ?></p>
                </div>
                <div class="portfolio-date">
                    <p><label><?php esc_html_e('Date:', 'am-logistics'); ?></label><?php echo mysql2date('M d Y', $meta_data->_zo_portfolio_date) ?></p>
                </div>
                <div class="zo-portfolio-content">
                    <label><?php esc_html_e('Description:', 'am-logistics'); ?></label>
                    <?php the_content();
                    ?>
                </div>
            </div>
