...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
        ...
        if ( ! empty( $item->_invalid ) ) {
            ...
            $title = sprintf( __( '%s (Invalid)', 'am-logistics'), $item->title );
        } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
            $classes[] = 'pending';
            /* translators: %s: title of menu item in draft status */
            $title = sprintf( __('%s (Pending)', 'am-logistics'), $item->title );
        }
            ...
            <dt class="menu-item-handle">
                ...
                <span class="item-controls">
                    ...
                    <span class="item-order hide-if-js">
                        ...
                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up','am-logistics'); ?>">&#8593;</abbr></a>
                        |
                        <a href="<?php
                        echo wp_nonce_url(
                            add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down','am-logistics'); ?>">&#8595;</abbr></a>
                    </span>
                    <a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" title="<?php esc_attr_e('Edit Menu Item','am-logistics'); ?>" href="<?php
                    ...
                    ?>"><?php esc_html_e( 'Edit Menu Item' ,'am-logistics'); ?></a>
                </span>
            </dt>
        </dl>
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
            <?php if( 'custom' == $item->type ) : ?>
                <p class="field-url description description-wide">
                    <label for="edit-menu-item-url-<?php echo esc_attr( $item_id ); ?>">
                        <?php esc_html_e( 'URL' ,'am-logistics'); ?><br>
            ...
            <p class="description description-thin">
                <label for="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>">
                    <?php esc_html_e( 'Navigation Label' ,'am-logistics'); ?><br>
                    <input type="text" id="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                </label>
            </p>
            <p class="description description-thin">
                <label for="edit-menu-item-attr-title-<?php echo esc_attr( $item_id ); ?>">
                    <?php esc_html_e( 'Title Attribute','am-logistics' ); ?><br>
            ...
            <p class="field-link-target description">
                <label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <?php esc_html_e( 'Open link in a new window/tab' ,'am-logistics'); ?>
                </label>
            </p>
            <p class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>">
                    <?php esc_html_e( 'CSS Classes (optional)' ,'am-logistics'); ?><br>
                    <input type="text" id="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                </label>
            </p>
            <p class="field-xfn description description-thin">
                <label for="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>">
                    <?php esc_html_e( 'Link Relationship (XFN)' ,'am-logistics'); ?><br>
                    <input type="text" id="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                </label>
            </p>
            <p class="field-description description description-wide">
                <label for="edit-menu-item-description-<?php echo esc_attr( $item_id ); ?>">
                    <?php esc_html_e( 'Description' ,'am-logistics'); ?><br>
                    ...
                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.','am-logistics'); ?></span>
                </label>
            </p>
            <?php
            /*
            ...
            if ( ! $depth ) {
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key)  . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) ) . "]"; ?>">
                            <option value="standard" <?php echo esc_attr( ( $value == 'standard' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Standard Dropdown', 'am-logistics' ); ?></option>
                            <option value="columns2" <?php echo esc_attr( ( $value == 'columns2' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( '2 columns dropdown', 'am-logistics' ); ?></option>
                            <option value="columns3" <?php echo esc_attr( ( $value == 'columns3' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( '3 columns dropdown', 'am-logistics' ); ?>
                            </option>
                            <option value="columns4" <?php echo esc_attr( ( $value == 'columns4' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( '4 columns dropdown', 'am-logistics' ); ?></option>
                            <option value="columns5" <?php echo esc_attr( ( $value == 'columns5' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( '5 columns dropdown', 'am-logistics' ); ?></option>
                        </select>
                    </label>
                </p>
                <?php
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="autodrop_submenu" <?php echo esc_attr( ( $value == 'autodrop_submenu' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Auto drop', 'am-logistics' ); ?></option>
                            <option value="drop_to_left" <?php echo esc_attr( ( $value == 'drop_to_left' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Drop To Left Side', 'am-logistics' ); ?></option>
                            <option value="drop_to_right" <?php echo esc_attr( ( $value == 'drop_to_right' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Drop To Right Side', 'am-logistics' ); ?></option>
                            <option value="drop_to_center" <?php echo esc_attr( ( $value == 'drop_to_center' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Drop To Center', 'am-logistics' ); ?></option>
                            <option value="drop_full_width" <?php echo esc_attr( ( $value == 'drop_full_width' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Full width', 'am-logistics' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php
            ...
            if($depth){
                ...
                <p class="description description-wide description_width_100 el_widget_area">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="" <?php echo esc_attr( ( $value == '' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Select Widget Area', 'am-logistics' ); ?></option>
                            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                    <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                        <option value="no_group" <?php echo esc_attr(  ( $value == 'no_group' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'No', 'am-logistics' ); ?></option>
                        <option value="group" <?php echo esc_attr( ( $value == 'group' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Yes', 'am-logistics' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            if($depth){
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="0" <?php echo esc_attr( ( $value == '0' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'No', 'am-logistics' ); ?></option>
                            <option value="1" <?php echo esc_attr( ( $value == '1' ) ? ' selected="selected" ' : '' ); ?>><?php esc_html_e( 'Yes', 'am-logistics' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php }
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d1">
                <label for="edit-<?php echo esc_attr( ($key) . '-' . ($item_id) ); ?>">
                    <?php echo do_shortcode( $title ); ?><br>
                    <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                    <input alt="#TB_inline?height=400&width=500&inlineId=<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) . '-popup' ); ?>" title="<?php esc_html_e( 'Click to browse icon', 'am-logistics' ) ?>" class="thickbox button-secondary submit-add-to-menu" type="button" value="<?php esc_html_e( 'Browse Icon', 'am-logistics' ) ?>" />
            ...
            if ( ! $depth ) {
                ...
                <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <span class='obtheme_long_desc'><?php echo do_shortcode( $title ); ?></span><br>
                        <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                        <button id="browse-edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class="set_custom_images button button-secondary submit-add-to-menu"><?php esc_html_e( 'Browse Image', 'am-logistics' ); ?></button>
                        <a class="button btn_clear button-primary" href="javascript: void(0);"><?php esc_html_e( 'Clear', 'am-logistics' ); ?></a>
                    </label>
                </p>
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                    <p class="link-to-original">
                        <?php printf( __('Original: %s', 'am-logistics'), '<a href="' . esc_url( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                    </p>
                <?php endif; ?>
                ...
                ); ?>"><?php esc_html_e('Remove','am-logistics'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr( $item_id ); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                ?>#menu-item-settings-<?php echo esc_attr( $item_id ); ?>"><?php esc_html_e('Cancel','am-logistics'); ?></a>
            </div>
