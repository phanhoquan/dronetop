...
function exam_meta_boxes($meta_boxes) {
    ...
    $meta_boxes[] = array(
        'title' => esc_html__('Information', 'am-logistics'),
        'post_types' => 'team',
        'tabs' => array(
            'profile' => esc_html__('Profile', 'am-logistics'),
            'social' => esc_html__('Social', 'am-logistics'),
        ),
        'tab_style' => 'left',
        'fields' => array(
            array(
                'id' => 'position',
                'name' => esc_html__('Position', 'am-logistics'),
                'type' => 'text',
                'tab' => 'profile',
            ),
            array(
                'id' => 'email',
                'name' => esc_html__('Email', 'am-logistics'),
                'type' => 'text',
                'tab' => 'profile',
            ),
            array(
                'id' => 'phone',
                'name' => esc_html__('Phone', 'am-logistics'),
                'type' => 'text',
                'tab' => 'profile',
            ),
            array(
                'id' => 'other',
                'name' => esc_html__('Other', 'am-logistics'),
                'type' => 'text_list',
                'tab' => 'profile',
                'clone' => 'true',
                'options' => array(
                    'key' => esc_html__('Key','am-logistics'),
                    'value' => esc_html__('Value','am-logistics'),
                ),
            ),
            array(
                'id' => 'facebook',
                'name' => esc_html__('Facebook', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'twitter',
                'name' => esc_html__('Twitter', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'google',
                'name' => esc_html__('Google Plus', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'vimeo',
                'name' => esc_html__('Vimeo', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'linkedin',
                'name' => esc_html__('LinkedIn', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'youtube',
                'name' => esc_html__('Youtube', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
            array(
                'id' => 'pinterest',
                'name' => esc_html__('Pinterest', 'am-logistics'),
                'type' => 'text',
                'tab' => 'social',
            ),
        ),
    ...
    $meta_boxes[] = array(
        'title' => esc_html__('Client Info', 'am-logistics'),
        'post_types' => 'testimonial',
        'tabs' => array(
            'from' => esc_html__('General', 'am-logistics'),
        ),
        'tab_style' => 'left',
        'fields' => array(
            array(
    ...
    $meta_boxes[] = array(
        'title' => esc_html__('Setting', 'am-logistics'),
        'post_types' => 'restaurant_menu',
        'tabs' => array(
            'from' => esc_html__('Price', 'am-logistics'),
        ),
        'tab_style' => 'left',
        'fields' => array(
            array(
                'id' => 'restaurant_menu_price',
                'name' => esc_html__('Enter Price', 'am-logistics'),
                'type' => 'text',
                'tab' => 'from',
            ),
        ),
    ...
    $meta_boxes[] = array(
        ...
        'tabs' => array(
            'info' => esc_html__('Infomation', 'am-logistics'),
            'gallery' => esc_html__('Gallery', 'am-logistics'),
            'header' => esc_html__('Header', 'am-logistics'),
            'page_title' => esc_html__('Page Title', 'am-logistics'),
            'layout' => esc_html__('Single Layout', 'am-logistics'),
        ),
        'tab_style' => 'left',
        'fields' => array(
            array(
                'id' => 'client',
                'name' => esc_html__('Client', 'am-logistics'),
                'type' => 'text',
                'tab' => 'info',
            ),
            array(
                'id' => 'role',
                'name' => esc_html__('Role', 'am-logistics'),
                'type' => 'text',
                'tab' => 'info',
            ),
            array(
                'id' => 'year',
                'name' => esc_html__('Year', 'am-logistics'),
                'type' => 'text',
                'tab' => 'info',
            ),
            array(
                'id' => 'author',
                'name' => esc_html__('Author', 'am-logistics'),
                'type' => 'text',
                'tab' => 'info',
            ),
			array(
				'id' => 'more_info',
				'name' => esc_html__('More Info','am-logistics'),
                'desc' => esc_html__('Key is name/keyword of service; Value is required of an option','am-logistics'),
				'type' => 'text_list',
				'tab' 	=> 'info',
                'clone' => 'true',
                'options' => array(
                    'key' => esc_html__('Key','am-logistics'),
                    'vaule' => esc_html__('Value','am-logistics'),
                ),
			),
            array(
                'id' => 'gallery',
                'name' => esc_html__('Select Gallery', 'am-logistics'),
                'type' => 'image_advanced',
                'tab' => 'gallery',
            ),
            array(
            ...
            array(
                "type" => "select",
                "name" => esc_html__("Select Layout", 'am-logistics'),
                'desc' => esc_html__('Select the layout you need show on the single portfolio', 'am-logistics'),
                "id" => "layout",
                "options" => array(
                    "" => "Default",
                    "1" => "Gallery Carousel",
            ...
            array(
                ...
                'type' => 'image_select',
                'options' => array(
                    'full' => get_template_directory_uri() . '/assets/images/logistics-no-sidebar.jpg',
                    'left' => get_template_directory_uri() . '/assets/images/logistics-left-sidebar.jpg',
                    'right' => get_template_directory_uri() . '/assets/images/logistics-right-sidebar.jpg',
                ),
                'std' => 'full',
            ...
            array(
                'id' => 'content_sidebar_type',
                'name' => esc_html__('Choose Sidebar', 'am-logistics'),
                'desc' => esc_html__('Controls the sidebar you want to show', 'am-logistics'),
                'type' => 'select',
                'options' => array(
                    'main' => esc_html__('Main Sidebar', 'am-logistics'),
                    'portfolio' => esc_html__('Portfolio Sidebar', 'am-logistics'),
                ),
                'std' => 'portfolio',
                'tab' => 'layout',
            ),
    ...
    $meta_boxes[] = array(
        'title' => esc_html__('Pricing Options', 'am-logistics'),
        'post_types' => 'pricing',
        'tabs' => array(
            'general' => array(
                'label' => esc_html__('General', 'am-logistics'),
                'icon' => 'dashicons-admin-generic'
            ),
            'feature' => array(
                'label' => esc_html__('Features', 'am-logistics'),
        ...
        'fields' => array(
			array(
				'id' => 'price',
				'name' => esc_html__('Price','am-logistics'),
				'type' => 'text',
				'tab' 	=> 'general',
			),
			array(
				'id' => 'discount',
				'name' => esc_html__('Discount','am-logistics'),
				'type' => 'text',
				'tab' 	=> 'general',
			),
			array(
				'id' => 'type',
				'name' => esc_html__('Type','am-logistics'),
				'type' => 'select',
				'options' => array(
					'7' => 'Weekly',
					'month' => 'Monthly',
			...
			array(
				'id' => 'button_text',
				'name' => esc_html__('Button Text','am-logistics'),
				'type' => 'text',
				'tab' 	=> 'general',
                'std' => 'Order Now',
			),
			array(
				'id' => 'featured',
				'name' => esc_html__('Set Featured','am-logistics'),
				'type' => 'checkbox',
				'tab' 	=> 'general',
			),
			array(
				'id' => 'options',
				'name' => esc_html__('Options','am-logistics'),
                'desc' => esc_html__('Key is name/keyword of service; Value is required of an option; Feature is field to highlight this option or not [Enter the tag bellow: "feature or light or dark" to the box, default is empty]','am-logistics'),
				'type' => 'text_list',
				'tab' 	=> 'feature',
                'clone' => 'true',
                'options' => array(
                    'key' => esc_html__('Key','am-logistics'),
                    'vaule' => esc_html__('Value','am-logistics'),
                    '0' => esc_html__('Feature','am-logistics')
                ),
			),
        ),
    );
    ...
    $meta_boxes[] = array(
        'title' => esc_html__('Settings', 'am-logistics'),
        'post_types' => 'bo_suu_tap',
        'tabs' => array(
            'gallery' => esc_html__('Gallery Images', 'am-logistics'),
        ),
        'tab_style' => 'left',
        'fields' => array(
            array(
                'id' => 'gallery',
                'name' => esc_html__('Chọn Ảnh liên quan', 'am-logistics'),
                'type' => 'image_advanced',
                'tab' => 'gallery',
            )
            ),
        ...
        $meta_boxes[] = array(
            ...
            $meta_boxes[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'price',
                        'name' => esc_html__('Nhập giá gốc','am-logistics'),
                        'type' => 'number',
                        'tab' 	=> 'gallery',
			            'desc' => __( 'Chú ý giá gốc phải lớn hơn giá giảm', 'am-logistics' ),
                    ),
                    array(
                        'id' => 'price_sale',
                        'name' => esc_html__('Nhập giá đã giảm','am-logistics'),
                        'type' => 'number',
                        'tab' 	=> 'gallery',
                        'desc' => __( 'Chú ý giá giảm phải nhỏ hơn giá gốc', 'am-logistics' ),
                    ),
                    ),
                );
    return $meta_boxes;
