<?php
class logistics_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
		$this->plugin_slug  = 'logistics-recent-posts-widget-with-thumbnails';
        parent::__construct(
            $this->plugin_slug, // Base ID
            esc_html__('Zo Recent Posts With Thumbnails', 'am-logistics'), // Name
            array('description' => esc_html__('List of your site&#8217;s most recent posts, with clickable title and thumbnails.', 'am-logistics'),) // Args
        );
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			<li>
				...
				<div class="recent-detail">
					...
					<?php if ( $show_date ) : ?>
						<div class="zo-post-date"><span><?php echo esc_html_e('Date: ', 'am-logistics');?><?php echo get_the_date('F j, Y');?></span></div>
					<?php	endif; ?>
...
<?php
	...
	function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'am-logistics' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php esc_html_e( 'Number of posts to show:', 'am-logistics' ); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Display post date?', 'am-logistics' ); ?></label></p>

		<h4><?php esc_html_e( 'Thumbnail Options', 'am-logistics' ); ?>:</h4>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_thumb' )); ?>"><?php esc_html_e( 'Display post featured image?', 'am-logistics' ); ?></label></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_width' )); ?>"><?php esc_html_e( 'Width of thumbnail', 'am-logistics' ); ?>:</label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_height' )); ?>"><?php esc_html_e( 'Height of thumbnail', 'am-logistics' ); ?>:</label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'keep_aspect_ratio' )); ?>"><?php esc_html_e( 'Use aspect ratios of original images?', 'am-logistics' ); ?> <em><?php esc_html_e( 'If checked the given width is used to determine the height of the thumbnail automatically. This option also supports responsive web design.', 'am-logistics' ); ?></em></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php esc_html_e( 'Do not show title?', 'am-logistics' ); ?> <em><?php esc_html_e( 'Make sure you set a default thumbnail for posts without a thumbnail, otherwise there will be no link.', 'am-logistics' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'try_1st_img' )); ?>"><?php esc_html_e( "Try to use the post's first image if post has no featured image?", 'am-logistics' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'only_1st_img' )); ?>"><?php esc_html_e( 'Use first image only, ignore featured image?', 'am-logistics' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'use_default' )); ?>"><?php esc_html_e( 'Use default thumbnail if no image could be determined?', 'am-logistics' ); ?></label></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'default_url' )); ?>"><?php esc_html_e( 'URL of default thumbnail (start with http://)', 'am-logistics' ); ?>:</label>
 ...
 * @since 1.0
 */
function logistics_register_recent_posts_widget_with_thumbnails () {
	register_widget('logistics_Recent_Posts_Widget_With_Thumbnails');
}
add_action('widgets_init', 'logistics_register_recent_posts_widget_with_thumbnails');
