                ...
                <?php
                    if (has_post_thumbnail() && !post_password_required() && !is_attachment() && wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full', false)):
                        if($atts['image_size']=='custom'){
                            ...
                            echo '<div class="zo-carousel-image"><img src="'. esc_url($image_resize) .'" alt="' . get_the_title() . '"></div>';
                        }else{
                            echo '<div class="zo-carousel-image">';
                            the_post_thumbnail($atts['image_size']);
                            echo '</div>';
                        }
                    else:
                        echo '<div class="zo-carousel-image"><img src="' . esc_url(ZO_IMAGES . 'no-image.jpg') . '" alt="' . get_the_title() . '" /></div>';
                    endif;
