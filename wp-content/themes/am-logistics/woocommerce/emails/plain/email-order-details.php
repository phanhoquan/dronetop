...
echo strtoupper( sprintf( __( 'Order number: %s', 'am-logistics' ), $order->get_order_number() ) ) . "\n";
...
if ( $sent_to_admin ) {
	echo "\n" . sprintf( __( 'View order: %s', 'am-logistics' ), admin_url( 'post.php?post=' . $order->get_id() . '&action=edit' ) ) . "\n";
}
