	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php _e( 'Qty', 'am-logistics' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'am-logistics' ); ?></th>
			</tr>
		</thead>
		<tbody>
