jQuery(document).ready(function (c) {
    ...
    c(document).on("click", "a.compare:not(.added)", function (o) {
        o.preventDefault();
        var e, t = c(this), a = c(".yith-woocompare-widget ul.products-list"), r = t.parents(".yith-woocompare-related"),
            i = !!r.length, n = i ? r.data("iframe") : "no";
        e = {
            ...
            success: function (o) {
                i ? (c("#yith-woocompare").replaceWith(c(o).filter("#yith-woocompare")), d(!1), c(document).trigger("yith_woocompare_page_refreshed", [!1]), c('.compare[data-product_id="' + t.data("product_id") + '"]').addClass("added").attr("href", "#").text(yith_woocompare.added_label)) : (o.added && t.addClass("added").attr("href", o.table_url).text(yith_woocompare.is_page ? yith_woocompare.view_label : yith_woocompare.added_label), d(o.widget_table), "yes" != yith_woocompare.auto_open || o.only_one || yith_woocompare.is_page || c("body").trigger("yith_woocompare_open_popup", {
        ...
        o.preventDefault();
        var e = this.href;
        void 0 !== e && c("body").trigger("yith_woocompare_open_popup", {response: e, button: c(this)})
        ...
        yith_woocompare.force_showing_popup || 768 <= c(window).width() ? (c.colorbox({
            ...
            c.colorbox.resize({width: "90%", height: "90%"})
        })) : window.location = yith_woocompare.page_url
    }), c(document).on("click", ".compare-list .remove a, a.yith_woocompare_clear", function (o) {
        o.preventDefault();
        var i = c(this), n = i.data("product_id"),
            e = {action: yith_woocompare.actionremove, id: n, iframe: i.data("iframe"), context: "frontend"};
        "undefined" != typeof c.fn.block && i.block({
            ...
            success: function (o) {
                ...
                var t = "all" == n ? ".compare.added" : '.compare[data-product_id="' + n + '"]', a = i.data("product_id"),
        ...
        yith_woocompare.is_page || (o.preventDefault(), c("body").trigger("yith_woocompare_open_popup", {
            response: function i(o, e) {
                ...
                var t = document.location.search, a = o + "=" + e, r = new RegExp("(&|\\?)" + o + "=[^&]*");
        ...
        yith_woocompare.is_page || (o.preventDefault(), c("body").trigger("yith_woocompare_open_popup", {response: c(this).attr("href")}))
    }).on("click", "li a.remove, a.clear-all", function (o) {
        o.preventDefault();
        var e = c(".yith-woocompare-widget .products-list").data("lang"), t = c(this), a = t.data("product_id");
        if (void 0 === a) {
            var r = t.attr("href").split("id=");
            a = r[1]
        }
        var i = {action: yith_woocompare.actionremove, id: a, context: "frontend", responseType: "product_list", lang: e},
        ...
        o.preventDefault();
        var e = c(this), t = e.closest("#yith-woocompare"), a = e.data("cat_id"),
            r = e.closest("#yith-woocompare-cat-nav > ul"), i = r.data("product_ids"), n = r.data("iframe");
        c.ajax({
    ...
    var a = function () {
        if ("undefined" != typeof c.fn.owlCarousel) {
            var o = c("#yith-woocompare-related"), e = o.find(".related-products"), t = o.find(".related-slider-nav");
            if (!o.length) return;
            e.owlCarousel({
                ...
                margin: 15,
                responsiveClass: !0,
                responsive: {0: {items: 2}, 480: {items: 3}, 768: {items: yith_woocompare.num_related}}
    ...
    function d(o) {
        var e = c(".yith-woocompare-widget ul.products-list"), t = e.data("lang");
        if (e.length) {
            if (o) e.html(o); else {
                var a = {action: yith_woocompare.actionreload, context: "frontend", lang: t};
    ...
    function p() {
        ...
        if (o.length) {
            var e = o.data("type"), t = o.data("text_o"), a = i(yith_woocompare.cookie_name),
        ...
        t.length && "undefined" != typeof c.fn.DataTable && "undefined" != typeof c.fn.imagesLoaded && (t.each(function () {
            ...
            o.imagesLoaded(function () {
                e = o.DataTable({
                    ...
                    autoWidth: !1,
                    destroy: !0,
                    fixedColumns: {leftColumns: yith_woocompare.fixedcolumns}
                })
            })
