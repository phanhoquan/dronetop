...
if( !class_exists( 'YITH_Woocompare_Frontend' ) ) {
    ...
    class YITH_Woocompare_Frontend {
        ...
        public function stylesheet_url() {
            ...
            $plugin_path   = array( 'path' => YITH_WOOCOMPARE_DIR . '/assets/css/font-awesome.min.css','path' => YITH_WOOCOMPARE_DIR . '/assets/css/style.css', 'url' => YITH_WOOCOMPARE_ASSETS_URL . '/css/style.css'  );
